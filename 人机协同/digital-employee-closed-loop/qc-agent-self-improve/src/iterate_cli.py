...
from iter_engine import run_qc_auto_iteration


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run qc auto iteration (merged in qc-agent-self-improve)")
...
def main() -> int:
    ...
    print(f"[OK] qc auto iteration result saved: {out}")
    return 0
